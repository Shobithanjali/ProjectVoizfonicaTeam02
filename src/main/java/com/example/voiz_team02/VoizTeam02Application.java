...
public class VoizTeam02Application {
    ...
    @Bean
    public CommandLineRunner dataLoader(DongleRepository repo, PrepaidRepository repo1, PostpaidRepositary repo2) {
        repo.deleteAll();
        repo1.deleteAll();
        repo2.deleteAll();
        return args -> {
            ...
            repo2.save(new Postpaidplan("Rs 249","3G/4G - 75Gb", "Local/Std Unlimited"));
            repo2.save(new Postpaidplan("Rs 449", "3G/4G - 125Gb", "Local/Std Unlimited"));
            repo2.save(new Postpaidplan("Rs 749", "3G/4G - 150Gb", "Local/Std Unlimited"));
